...
describe Oystercard do
  ...
  describe '#top_up' do
    ...
    it 'Raises an error when top up exceeds the limit of £90' do
      ...
      expect { subject.top_up(1) }.to raise_error("Maximum top up limit of #{maximum_balance} exceeded")
    end
  end
  ...
  describe '#touch_in' do
    ...
    it 'raises an error when balance is less minimum balance' do
      expect { subject.touch_in }.to raise_error("Insufficient balance below minimum #{Oystercard::MINIMUM_BALANCE}")
    end
  end
